...
function CourseDetails() {
  ...
  return courseData ? (
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='absolute top-0 left-0 w-full h-section-height -z-1 bg-gradienr-toob from-cyan-100/70'>
      </div>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        <p className='text-sm '>Course By <span className='text-blue-600 underline'>Harkirat</span></p>
                    ...
                    <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                      <div className='flex items-center justify-between px-4 py-3 cursor-pointer select-none' onClick={()=> toggleSection(index)}>
                        <div className='flex items-center gap-2'>
                          <img src={assets.down_arrow_icon} alt="arrow" className={`transform transition-transform ${openSections[index] ? '-rotate-90 duration-200': ''}`} />
        ...
        <div className='p-5'>
          ...
          <div className='pt-6'>
            ...
            <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
              ...
              <li>Quizzes to rest your knowledge.</li>
              <li>Crertificate of completion.</li>
            </ul>
          </div>
        </div>
      </div>
